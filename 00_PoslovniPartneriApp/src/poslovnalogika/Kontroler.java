...
public class Kontroler {
    ...
    public int uzmiNajveciID() throws Exception {
        db.ucitajDriver();
        db.otvoriKonekciju();
        int najveciID = db.uzmiNajveciIDPartnera();
        db.commitTransakcije();
        db.zatvoriKonekciju();
        return najveciID;
    }
    ...
    public List<PoslovniPartner> nadjiPartnera(String kriterijumPretrage) throws Exception {
        db.ucitajDriver();
        db.otvoriKonekciju();
        List<PoslovniPartner> lista = db.nadjiPartnera(kriterijumPretrage);
        db.commitTransakcije();
        db.zatvoriKonekciju();
        return lista;
    }
    ...
    public List<Racun> vratiRacune() throws Exception {
        db.ucitajDriver();
        db.otvoriKonekciju();
        List<Racun> lista = db.vratiRacune();
        db.commitTransakcije();
        db.zatvoriKonekciju();
        return lista;
    }
    ...
    public List<Proizvod> vratiProizvodePrikaz() throws Exception {
        db.ucitajDriver();
        db.otvoriKonekciju();
        List<Proizvod> lista = db.vratiProizvodePrikaz();
        db.commitTransakcije();
        db.zatvoriKonekciju();
        return lista;
    }
    ...
    public List<Proizvod> nadjiProizvode(String kriterijumPretrage) throws Exception {
        db.ucitajDriver();
        db.otvoriKonekciju();
        List<Proizvod> lista = db.nadjiProizvode(kriterijumPretrage);
        db.commitTransakcije();
        db.zatvoriKonekciju();
        return lista;
    }
