...
public class FrmUnosPartnera extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jbtnUzmiNajveciID = new javax.swing.JButton();
        jtxtNajveciID = new javax.swing.JTextField();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);

        jLabel1.setText("Partner ID:");

        jtxtPartnerID.setEditable(false);
        ...
        jbtnUzmiNajveciID.setText("Uzmi najveci ID");
        jbtnUzmiNajveciID.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbtnUzmiNajveciIDActionPerformed(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jbtnUzmiNajveciID, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(jtxtNajveciID))))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jbtnUzmiNajveciID))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jbtnDodajRed)
                    .addComponent(jbtnObrisiRed)
                    .addComponent(jtxtNajveciID, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        private void jbtnSacuvajActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnSacuvajActionPerformed
            try {
                ...
                jtxtPartnerID.setText(String.valueOf(Kontroler.getInstance().uzmiNajveciID() + 1));
    ...
    private void jbtnDodajRedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnDodajRedActionPerformed
        try {
            ...
            model.dodajRed(Kontroler.getInstance().uzmiNajveciID());
        } catch (Exception ex) {
    ...
    private void jbtnUzmiNajveciIDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnUzmiNajveciIDActionPerformed
        try {
            int najveciID = Kontroler.getInstance().uzmiNajveciID();
            jtxtNajveciID.setText(String.valueOf(najveciID));
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "Izgleda nema nijednog partnera u tabeli...");
        }
    }//GEN-LAST:event_jbtnUzmiNajveciIDActionPerformed
    ...
    private javax.swing.JButton jbtnUzmiNajveciID;
    ...
    private javax.swing.JTextField jtxtNajveciID;
