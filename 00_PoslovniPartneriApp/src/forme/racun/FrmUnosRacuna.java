...
import domen.Racun;
import forme.racun.model.PrikazTableModel;
...
public class FrmUnosRacuna extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jScrollPane3.setViewportView(jtblPrikaz);
    ...
    private void srediFormu() {
        try {
            ...
            List<Racun> lista = Kontroler.getInstance().vratiRacune();
            PrikazTableModel model1 = new PrikazTableModel(lista);
            jtblPrikaz.setModel(model1);
