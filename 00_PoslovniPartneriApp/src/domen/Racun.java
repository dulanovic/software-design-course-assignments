...
public class Racun {
    ...
    private int ukupanBrojStavki;

    public Racun() {
        stavkaList = new ArrayList<>();
    }
    
    public Racun(int racunID, double ukupanIznos, int ukupnaKolicina, int ukupanBrojStavki) {
        this.racunID = racunID;
        this.ukupanIznos = ukupanIznos;
        this.ukupnaKolicina = ukupnaKolicina;
        this.ukupanBrojStavki = ukupanBrojStavki;
    }
    ...
    public int getUkupanBrojStavki() {
        return ukupanBrojStavki;
    }

    public void setUkupanBrojStavki(int ukupanBrojStavki) {
        this.ukupanBrojStavki = ukupanBrojStavki;
    }
}
